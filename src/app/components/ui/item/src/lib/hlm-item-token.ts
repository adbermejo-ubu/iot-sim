...
export function provideHlmItemConfig(
    config: Partial<HlmItemConfig>,
): ValueProvider {
    return {
...
export function provideHlmItemMediaConfig(
    config: Partial<HlmItemMediaConfig>,
): ValueProvider {
    return {
...
export function injectHlmItemMediaConfig(): HlmItemMediaConfig {
    return (
        inject(HlmItemMediaConfigToken, { optional: true }) ??
        defaultMediaConfig
    );
}
