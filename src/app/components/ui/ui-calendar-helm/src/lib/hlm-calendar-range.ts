                        ...
                        <tr
                            *brnCalendarWeek="let week"
                            ...
                            @for (
                                ...
                                <td
                                    brnCalendarCell
                                    class="relative h-8 w-8 p-0 text-center text-sm focus-within:relative focus-within:z-20 data-[selected]:bg-accent data-[selected]:data-[outside]:bg-accent/50 first:data-[selected]:rounded-l-md last:data-[selected]:rounded-r-md [&:has([aria-selected].day-range-end)]:rounded-r-md">
                                    <button
                                        brnCalendarCellButton
                                        [date]="date"
                                        [class]="_btnClass">
