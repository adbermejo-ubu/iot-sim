                ...
                <div class="space-y-4">
                    <div class="relative flex items-center justify-center pt-1">
                        ...
                        <div class="flex items-center space-x-1">
                            ...
                            <button
                                brnCalendarNextButton
                                class="absolute right-1 inline-flex size-8 items-center justify-center whitespace-nowrap rounded-md bg-transparent p-0 text-sm font-medium text-popover-foreground transition-colors hover:bg-accent hover:text-accent-foreground hover:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50">
                                <ng-icon
                                    hlm
                    ...
                    <tbody role="rowgroup">
                        <tr
                            *brnCalendarWeek="let week"
                            ...
                            @for (
                                date of week;
                                track _dateAdapter.getTime(date)
                            ) {
                                <td
                                    brnCalendarCell
                                    class="relative size-8 p-0 text-center text-sm focus-within:relative focus-within:z-20 data-[selected]:bg-accent data-[selected]:data-[outside]:bg-accent/50 first:data-[selected]:rounded-l-md last:data-[selected]:rounded-r-md [&:has([aria-selected].day-range-end)]:rounded-r-md">
                                    <button
                                        brnCalendarCellButton
                                        [date]="date"
                                        [class]="_btnClass">
