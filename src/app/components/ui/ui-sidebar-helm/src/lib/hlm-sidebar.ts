    ...
    template: `
        ...
        @if (collapsible() === "none") {
            <div data-slot="sidebar" [class]="_nonCollapsibleComputedClass()">
                <ng-container
                    *ngTemplateOutlet="contentContainer"></ng-container>
            </div>
            ...
            <hlm-sheet
                ...
                (stateChanged)="
                    _sidebarService.setOpenMobile($event === 'open')
                ">
                <hlm-sheet-content
            ...
            <div
                ...
                [attr.data-collapsible]="
                    _sidebarService.state() === 'collapsed' ? collapsible() : ''
                "
                ...
                <div
                    ...
                    [class]="_sidebarGapComputedClass()"></div>
                <div
