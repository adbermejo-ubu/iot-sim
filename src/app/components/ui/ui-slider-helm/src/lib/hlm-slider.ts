...
@Component({
    ...
    template: `
        ...
        <span
            class="focus-visible:outline-hidden absolute block size-4 shrink-0 -translate-x-1/2 rounded-full border border-primary bg-background shadow-sm ring-ring/50 transition-[color,box-shadow] hover:ring-4 focus-visible:ring-4 disabled:pointer-events-none disabled:opacity-50"
            brnSliderThumb></span>
    `,
    host: {
